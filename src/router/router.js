...
export const appRouter = [
    {
        ...
        component: Main,
        children: [
            { path: 'index', title: '标签管理', name: 'tag_index', component: resolve => { require(['@/views/tag/tag.vue'], resolve); } }
        ]
    },
    {
        path: '/comment',
        ...
        component: Main,
        children: [
            { path: 'index', title: '评论管理', name: 'comment_index', component: resolve => { require(['@/views/comment/comment.vue'], resolve); } }
        ]
    },
    {
        path: '/article',
